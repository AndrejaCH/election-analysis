...
The purpose of this analysis is to generate a vote count report to certify U.S. congressional race in Colorado precinct and represent:
   ...
   including the percentage of votes from each county out of the total count and the voter turnout for each county. 
   3. The county with the highest turnout.
   4. The complete list of candidates who received votes, 
   including a percentage of votes each candidate won and the total number of votes each candidate received.
